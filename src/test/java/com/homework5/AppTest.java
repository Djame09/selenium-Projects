...
public class AppTest
{
    ...
    public void beforeMethod() {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Julian\\IdeaProjects\\automationtesting\\src\\driver\\chromedriver.exe");
    ...
    public void test2() throws InterruptedException { //testing the creation of an account
        ...
        driver.findElement(By.xpath("//*[@id=\"wag-RXUser-firstname\"]")).sendKeys("djaha");
        driver.findElement(By.xpath("//*[@id=\"wag-RXUser-lastname\"]")).sendKeys("TESTER");
        driver.findElement(By.xpath("//*[@id=\"wag-email\"]")).sendKeys("djahazarour7@gmail.com");
        driver.findElement(By.xpath("//*[@id=\"wag-password\"]")).sendKeys("Djamel1990");
    ...
    public void test3() throws InterruptedException { //testing the signin with correct credentials
        driver.findElement(By.cssSelector("body > header > div.nav__wrapper-test.testing > nav > div > div > div.right-links > div > a > span.icon.icon__arrow-down > svg")).click();
        driver.findElement(By.xpath("//*[@id=\"pf-dropdown-signin\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"user_name\"]")).sendKeys("djahazarour7@gmail.com");
        driver.findElement(By.xpath("//*[@id=\"user_password\"]")).sendKeys("Djamel1990");
        driver.findElement(By.xpath("//*[@id=\"submit_btn\"]")).click();
    ...
    public void test7() throws InterruptedException { //testing the accessibility of the sub menu "shop products dropdown"
        ...
        driver.findElement(By.cssSelector("#menu-shop-products")).click();
    }
    ...
    public void test8() throws InterruptedException { //testing the add to cart functionality
        ...
        driver.findElement(By.cssSelector("#addtocartdialog > div.modal__content-contain.modal__white.upsell_atc > button > span > svg")).click();
        driver.findElement(By.cssSelector("#pf-icon__cart-full")).click();
        //driver.findElement(By.cssSelector("#addToCart-view-cart")).click();
    }
